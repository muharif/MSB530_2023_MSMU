...
legal_alcohol <- function(age){
  #WRITE YOUR CODE HERE
  if(age >= 21){
    result = 'This person is allowed to purchase alcoholic beverages'
  } else {
    result = 'This person is not allowed to purchase alcoholic beverages'
  }
...
km_to_miles_and_ft <- function(km){
  #WRITE YOUR CODE HERE
  miles = km %/% 1.609
  feet = km %% 1.609 * 3290.84
  
  result = paste(miles, 'miles and', feet, 'feet')
